import { Box, Card, CardContent, CardMedia, Chip, Divider, Grid, Typography, Dialog, DialogActions, DialogContent, DialogTitle, IconButton } from '@mui/material';
...
const TaetigkeitDetailedView = () => {
    const { id } = useParams();
    const taetigkeit = mockTaetigkeiten.find((taetigkeit) => taetigkeit.id === id);
    ...
    return (
        <>
            <HeaderWithBackground
                ...
                headerSize={"h2"}
                imageName={taetigkeit.photos[0].split("/")[2]}
                heightInRem={20}
            ...
            <Card sx={{ maxWidth: 900, margin: 'auto', mt: 4 }}>
                <CardContent>
                    ...
                    <Typography variant="h4" color="#b32b2b" gutterBottom>
                        {taetigkeit.alarmtitelStichwort}
                        {taetigkeit.alarmstichwort && (
                            <Typography variant="body2" color="#000000">
                                (Alarmstichwort: {taetigkeit.alarmstichwort})
                            </Typography>
                        )}
                    </Typography>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={6}>
                            <Typography variant="body1">
                                <strong>Datum:</strong> {taetigkeit.date}
                            </Typography>
                        </Grid>
                        <Grid item xs={6}>
                            <Typography variant="body1">
                    ...
                    <Box mt={2}>
                        ...
                        <Grid container spacing={1}>
                            {taetigkeit.eingesetzteFeuerwehren.map((feuerwehr, index) => (
                                <Grid item key={index}>
                    ...
                    <Box mt={2}>
                        ...
                        <Grid container spacing={1}>
                            {taetigkeit.eingesetzteAutos.map((auto, index) => (
                                <Grid item key={index}>
                                    <Chip label={auto} color="secondary"/>
                                </Grid>
                            ))}
                        </Grid>
                    </Box>
